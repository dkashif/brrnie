    ...
    def create(self, validated_data):
        ...
        user = User.objects.create_user(
            username=validated_data[
                "email"
            ],  # Treat email as email"],  # Treat email as username
...
class UserProfileSerializer(serializers.ModelSerializer):
    ...
    def update(self, instance, validated_data):
        ...
        instance.receive_expiration_reminders = validated_data.get(
            "receive_expiration_reminders", instance.receive_expiration_reminders
        )
        instance.days_before_expiration = validated_data.get(
            "days_before_expiration", instance.days_before_expiration
        )
        instance.save()
        return instance
